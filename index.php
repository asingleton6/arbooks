...
<body>
  ...
  <section class="team-members">
    ...
    <div class="content padding-both">
      <div class="third">
        <div class="circle-image"><img class="kyoko" src="img/kyoko.png"/></div>
        <h4 class="dark-purple-text">Kyoko Lyons <br /> <i class="lighter-text">Founder</i></h4>
      </div>
      <div class="third">
        <div class="circle-image"><img class="itsumi" src="img/itsumi.png"/></div>
        <h4 class="dark-purple-text">Itsumi Fukuda <br /> <i class="lighter-text">Position</i></h4>
      </div>
      <div class="third">
        <div class="circle-image"><img class="natalia" src="img/natalia.png"/></div>
